...
def path(planner, xs, ys, rad_s, xe, ye, rad_e):
    points = planner.dubins_path((xs,ys,rad_s),(xe,ye,rad_e))
    return points[:, 0], points[:, 1]

def length(planner, xs, ys, rad_s, xe, ye, rad_e):
    return calculate_curve_length( planner.dubins_path((xs,ys,rad_s),(xe,ye,rad_e)) )
